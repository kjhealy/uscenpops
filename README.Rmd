...
The data are sourced from the [US Census Bureau](http://census.gov), principally from the residential estimates available in various formats and spans at <https://www2.census.gov/programs-surveys/popest/tables/>.
